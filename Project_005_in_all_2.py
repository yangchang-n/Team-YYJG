...
st.markdown('<h4 style = \'text-align : right\'>v0.0.3-alpha</h4>', unsafe_allow_html = True)
...
def main_page() :
    ...
    st.text('사진 출처 : https://m.post.naver.com/viewer/postView.nhn?volumeNo=18619718&memberNo=35171416')
    st.text(
    '''
    ...
    st.text(
    '''
    Project 001 넌 이렇게 찍혀야 제일 멋있어! (2022.08.04 ~ 2022.08.26)
    - Project Manager : 양창은
...
def sub_page_3() :
    ...
    st.markdown('<h3 style = \'text-align : center;\'>영상 파일 (mp4 형식) - 빠른 분석 버전</h3>', unsafe_allow_html = True)   
...
page_names_to_funcs = {
    ...
    '영상 파일 (mp4 형식) - 빠른 분석 버전, alpha test' : sub_page_3,
    '사진 파일 (jpg 형식) - coming soon!' : sub_page_4
}
